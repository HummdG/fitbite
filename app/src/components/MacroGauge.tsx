...
type Props = {
  /** Emoji shown in the centre of the ring (e.g. 🔥 for calories). */
  emoji: string;
  label: string;
  value: number;
  target: number;
 ...
 * macro emoji in the centre, and the label + "value / target unit" beneath.
 * This is the Today dashboard's primary metric (Calories / Protein / Fibre). */
export function MacroGauge({ emoji, label, value, target, unit, color, size = 96 }: Props) {
